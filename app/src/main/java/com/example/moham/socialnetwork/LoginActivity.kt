...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ForgetPasswordLink!!.setOnClickListener { startActivity(Intent(this@LoginActivity, ResetPasswordActivity::class.java)) }

        LoginButton!!.setOnClickListener { AllowingUserToLogin() }
        ...
        mGoogleSignInClient = GoogleApiClient.Builder(this)
                .enableAutoManage(this) { Toast.makeText(this@LoginActivity, "Connection to Google Sign in failed...", Toast.LENGTH_SHORT).show() }
    ...
    private fun firebaseAuthWithGoogle(acct: GoogleSignInAccount) {
        ...
        mAuth!!.signInWithCredential(credential).addOnCompleteListener(this) { task ->
            if (task.isSuccessful) {
                ...
                Toast.makeText(this@LoginActivity, "Not Authenticated : $message", Toast.LENGTH_SHORT).show()
                loadingBar!!.dismiss()
            }
        }
    }
